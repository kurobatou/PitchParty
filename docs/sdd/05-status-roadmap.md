...
- **Sin micrófono USB/Bluetooth conectado al servidor.** Era una opción secundaria en el plan original; todo el audio hoy entra exclusivamente por WebSocket desde el navegador de un celular.
...
- **Sin tests automatizados.** No hay carpeta de tests ni script de CI en el repo. La verificación de cada cambio es manual (levantar el servidor, probar en navegador/WebSocket a mano).
